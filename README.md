...
MCP server for inspecting and modifying Three.js scenes in real time — **64 tools** for objects, materials, shaders, textures, animations, performance monitoring, memory diagnostics, and code generation.
...
- [Tools reference](docs/tools.md) — all 64 tools with parameters
